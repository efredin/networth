...
export class BalanceSheet extends React.Component<BalanceSheetProps> {
  ...
  // debounedUpdateEntry = debounce((balanceSheetId: string, entry: State.Entry, entryType: State.EntryType) => {
  //   this.props.updateEntry(balanceSheetId, entry, entryType);
  // }, 500);
